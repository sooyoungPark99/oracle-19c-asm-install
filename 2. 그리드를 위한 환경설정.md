...
# 2. yum lock 파일 삭제
rm -f /var/run/yum.pid     <-- yum 락 파일 위치는 여기에 고정
...
[root@asmtest ~]#
[root@asmtest ~]#
[root@asmtest ~]# mkdir -p /app/grid     # grid 설치 디렉토리 생성
[root@asmtest ~]# chown -R oracle:oinstall /app   # /app 하위 전체를 oracle 소유로 변경
[root@asmtest ~]# chmod -R 775 /app   # /app 하위 전체에 읽기/쓰기/실행 권한 부여
[root@asmtest ~]#
